...
const ALL_PRODUCTS = [
  { 
    ...
    description: 'Heavyweight oversized streetwear T-shirt in pitch black, featuring a striking back-print of Zenitsu from Demon Slayer channeling thunder breathing, surrounded by electric yellow lightning. Features dual athletic sleeve stripes.' 
  },
  { 
    id: '2', 
    ...
    description: 'Premium cream-colored heavy oversized tee. Features an anime graphic of a character wearing a gas mask and headphones, holding a baseball bat behind their head in front of a red brushstroke block with the kanji "死ぬ" (Shi-nu).' 
  },
  { 
    id: '3', 
    ...
    description: 'Streetwear drop-shoulder tee in soft pastel pink. Front-printed with a vertical stack of five grayscale panels highlighting the expressive eyes of Goku, Naruto, Luffy, Saitama, and Edward Elric.' 
  },
  { 
    id: '4', 
    ...
    description: 'Pitch black 240 GSM drop-shoulder tee with a vibrant back-print of a cool graffiti teddy bear wearing streetwear gear. Detailed with random doodles, words, and sketches for a raw skater aesthetic.' 
  },
  { 
    id: '5', 
    ...
    description: 'Heavyweight combed white cotton streetwear tee. Features an intense manga illustration of Yuta Okkotsu and the cursed spirit Rika from Jujutsu Kaisen, highlighted by deep purple cursed energy flares.' 
  },
  { 
    id: '6', 
    ...
    description: 'Premium acid-washed gray streetwear tee. Back-printed with a detailed cyan/turquoise cybernetic spine exoskeleton that traces the spine, complete with shoulder socket circuit line details.' 
  },
  { 
    id: '7', 
    ...
    description: 'Premium forest green drop-shoulder tee. Illustrated with a fine-line profile portrait surrounded by detailed yellow and green tropical foliage, complete with bold typography declaring love without boundaries.' 
  },
  { 
    id: '8', 
    ...
    description: 'Pitch black drop-shoulder tee displaying a high-top sneaker sitting atop a skull-shaped flower pot. Set against a backdrop of deep purple foliage, branches, and a starry night sky.' 
  },
  { 
    id: '9', 
    ...
    description: 'Brick red oversized streetwear T-shirt. Showcases a bold claymation-style character graphic with a yellow "WOOPS!" bubble logo and custom "STAY SICK" blue lettering embedded in the beard detail.' 
  },
  { 
    id: '10', 
    ...
    description: 'Classic heavyweight black streetwear tee featuring bold "BREAK RULES" text torn apart by realistic hands ripping through the fabric. Accented with the sub-text "NOTHING IS ORIGINAL" for a rebellious vibe.' 
  },
  { 
    id: '11', 
    ...
    description: 'Bold black streetwear oversized tee decorated with a retro pop-art collage. Features colorful illustrations of skateboards, bicycles, comic graphics, and graffiti words like SWAG and DREAMS.' 
  },
  { 
    id: '12', 
    ...
    description: 'Acid-washed charcoal gray streetwear tee. Displaying a high-density, gritty, dark illustration of a screaming berserker beast or devil, capturing a hardcore heavy-metal aesthetic.' 
  },
  { 
    id: '13', 
    ...
    description: "Pitch black heavyweight oversized tee. Back-printed with Luffy's Gear 5 Sun God Nika laughing form, layered with gold-colored 'MONKEY D. LUFFY' and 'SUN GOD NIKA GEAR 5' block letters." 
  },
  { 
    id: '14', 
    ...
    description: 'Black streetwear tee featuring white side contrast panels. The back-print showcases Goku in his mastered Ultra Instinct state backed by the legendary dragon Shenron in a stylized monochrome layout with cyan kanji.' 
  }
];
